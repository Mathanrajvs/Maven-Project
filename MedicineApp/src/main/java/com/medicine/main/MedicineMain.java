		...
		try (Scanner sc = new Scanner(System.in)) {
			do {
				...
				case 2:
					...
					System.out.println(
							"1.Show Name \t 2.Show Category \t 3.Show Name and Category \t 4.Show Category and Brand \t5.Show Category and Cost \t6.Check Available Medicine \t7.Add to Cart \t8.Show Booking");
